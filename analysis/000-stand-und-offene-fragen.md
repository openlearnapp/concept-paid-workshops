...
## Auswertung — was im Review zu klären ist

Sechs Punkte sind noch offen. Sie betreffen Entscheidungen, die das Konzept nicht allein
treffen kann — sie brauchen eine Review-Entscheidung.
...
4. **Freischalt-Link** — Wie genau ist der Wiederverkauf-/Marktplatz-Gedanke gemeint?
5. **Library** — Bestätigung, dass `open-learn.js` erweitert wird. Soll sie auch eine
   Backend-Vorlage für den Kauf mitbringen?
6. **Konzept-Repo** — Ablageort auf GitHub bestätigen.

## Nächste Schritte

1. Offene Fragen im Review klären.
2. Konzept-Repo zum Durchklicken bereitstellen.
3. Konzept nach den Review-Antworten überarbeiten.
4. Erwartet: 2–3 Iterationen, bis das Konzept implementierbar ist.
5. Implementation erst nach ausdrücklicher Freigabe.
