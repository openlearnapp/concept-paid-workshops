...
3. **Dann das Konzept:** [`specs/001-paid-workshops.md`](specs/001-paid-workshops.md) — der Konzept-Text.
...
| `analysis/` | Auswertung nach jeder Review-Iteration (kommt später) |
...
Konzept v1 · Fallbeispiel als Mockup · keine Implementation · im Review
