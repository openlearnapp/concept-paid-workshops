...
1. Reza prüft das Fallbeispiel lokal.
2. Bei OK: Repo `concept-paid-workshops` auf GitHub (Reza9696) anlegen, Inhalt pushen.
3. PR mit dem Konzept aufmachen, Link an Felix.
4. Felix-Iterationen am Spec-Dokument (erwartet 2–3 Runden).
